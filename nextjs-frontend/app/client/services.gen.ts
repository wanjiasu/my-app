...
import type {
    ...
    AuthJwtLogoutAuthJwtLogoutPostResponse,
    ...
    AuthenticatedRouteAuthenticatedRouteGetError,
...
export const authJwtLoginAuthJwtLoginPost = <ThrowOnError extends boolean = false>(options: Options<AuthJwtLoginAuthJwtLoginPostData, ThrowOnError>) => {
    return (options?.client ?? client).post<AuthJwtLoginAuthJwtLoginPostResponse, AuthJwtLoginAuthJwtLoginPostError, ThrowOnError>({
        ...options,
 ...
 * Auth:Jwt.Logout
 */
export const authJwtLogoutAuthJwtLogoutPost = <ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) => {
    return (options?.client ?? client).post<AuthJwtLogoutAuthJwtLogoutPostResponse, AuthJwtLogoutAuthJwtLogoutPostError, ThrowOnError>({
        ...options,
        url: '/auth/jwt/logout'
    });
};
...
export const registerRegisterAuthRegisterPost = <ThrowOnError extends boolean = false>(options: Options<RegisterRegisterAuthRegisterPostData, ThrowOnError>) => {
    return (options?.client ?? client).post<RegisterRegisterAuthRegisterPostResponse, RegisterRegisterAuthRegisterPostError, ThrowOnError>({
        ...options,
        url: '/auth/register'
    });
};
...
export const resetForgotPasswordAuthForgotPasswordPost = <ThrowOnError extends boolean = false>(options: Options<ResetForgotPasswordAuthForgotPasswordPostData, ThrowOnError>) => {
    return (options?.client ?? client).post<ResetForgotPasswordAuthForgotPasswordPostResponse, ResetForgotPasswordAuthForgotPasswordPostError, ThrowOnError>({
        ...options,
...
export const resetResetPasswordAuthResetPasswordPost = <ThrowOnError extends boolean = false>(options: Options<ResetResetPasswordAuthResetPasswordPostData, ThrowOnError>) => {
    return (options?.client ?? client).post<ResetResetPasswordAuthResetPasswordPostResponse, ResetResetPasswordAuthResetPasswordPostError, ThrowOnError>({
        ...options,
...
export const verifyRequestTokenAuthRequestVerifyTokenPost = <ThrowOnError extends boolean = false>(options: Options<VerifyRequestTokenAuthRequestVerifyTokenPostData, ThrowOnError>) => {
    return (options?.client ?? client).post<VerifyRequestTokenAuthRequestVerifyTokenPostResponse, VerifyRequestTokenAuthRequestVerifyTokenPostError, ThrowOnError>({
        ...options,
...
export const verifyVerifyAuthVerifyPost = <ThrowOnError extends boolean = false>(options: Options<VerifyVerifyAuthVerifyPostData, ThrowOnError>) => {
    return (options?.client ?? client).post<VerifyVerifyAuthVerifyPostResponse, VerifyVerifyAuthVerifyPostError, ThrowOnError>({
        ...options,
        url: '/auth/verify'
    });
};
 ...
 * Users:Current User
 */
export const usersCurrentUserUsersMeGet = <ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) => {
    return (options?.client ?? client).get<UsersCurrentUserUsersMeGetResponse, UsersCurrentUserUsersMeGetError, ThrowOnError>({
        ...options,
        url: '/users/me'
    });
};
...
export const usersPatchCurrentUserUsersMePatch = <ThrowOnError extends boolean = false>(options: Options<UsersPatchCurrentUserUsersMePatchData, ThrowOnError>) => {
    return (options?.client ?? client).patch<UsersPatchCurrentUserUsersMePatchResponse, UsersPatchCurrentUserUsersMePatchError, ThrowOnError>({
        ...options,
        url: '/users/me'
    });
};
...
export const usersUserUsersIdGet = <ThrowOnError extends boolean = false>(options: Options<UsersUserUsersIdGetData, ThrowOnError>) => {
    return (options?.client ?? client).get<UsersUserUsersIdGetResponse, UsersUserUsersIdGetError, ThrowOnError>({
        ...options,
        url: '/users/{id}'
    });
};
...
export const usersPatchUserUsersIdPatch = <ThrowOnError extends boolean = false>(options: Options<UsersPatchUserUsersIdPatchData, ThrowOnError>) => {
    return (options?.client ?? client).patch<UsersPatchUserUsersIdPatchResponse, UsersPatchUserUsersIdPatchError, ThrowOnError>({
        ...options,
        url: '/users/{id}'
    });
};
...
export const usersDeleteUserUsersIdDelete = <ThrowOnError extends boolean = false>(options: Options<UsersDeleteUserUsersIdDeleteData, ThrowOnError>) => {
    return (options?.client ?? client).delete<UsersDeleteUserUsersIdDeleteResponse, UsersDeleteUserUsersIdDeleteError, ThrowOnError>({
        ...options,
        url: '/users/{id}'
    });
};
 ...
 * Authenticated Route
 */
export const authenticatedRouteAuthenticatedRouteGet = <ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) => {
    return (options?.client ?? client).get<AuthenticatedRouteAuthenticatedRouteGetResponse, AuthenticatedRouteAuthenticatedRouteGetError, ThrowOnError>({
        ...options,
